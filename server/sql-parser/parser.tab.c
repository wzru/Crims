...
{
       0,    98,    98,    99,   102,   109,   117,   124,   130,   138,
     144,   150,   156,   162,   168,   174,   180,   186,   192,   198,
     204,   210,   219,   226,   235,   236,   241,   246,   251,   256,
     264,   275,   280,   286,   291,   299,   306,   313,   319,   328,
     334,   343,   349,   358,   368,   373,   385,   388,   393,   396,
     401,   404,   412,   420,   424,   430,   433,   436,   441,   444,
     449,   452,   456,   462,   468,   476,   480,   484,   490,   496,
     500,   504,   508,   512,   517,   521,   527,   528,   531,   538,
     545,   550,   556,   567,   576,   586,   595,   595,   598,   601,
     606,   611,   618,   622,   629,   639,   650,   658
};
#endif
...
#line 102 "parser.y"
    {
        ...
        sprintf_s((yyval.expr)->text, EXPR_LENGTH, "%s", (yyvsp[(1) - (1)].strval));
...
#line 109 "parser.y"
    {
        ...
        sprintf_s((yyval.expr)->text, EXPR_LENGTH, "%s.%s", (yyvsp[(1) - (3)].strval), (yyvsp[(3) - (3)].strval));
...
#line 124 "parser.y"
    {
        ...
        sprintf_s((yyval.expr)->text, EXPR_LENGTH, "%d", (yyvsp[(1) - (1)].intval));
    }
    break;
...
#line 130 "parser.y"
    {
        ...
        sprintf_s((yyval.expr)->text, EXPR_LENGTH, "%f", (yyvsp[(1) - (1)].floatval));
    }
    break;
...
#line 138 "parser.y"
    { 
        ...
        sprintf_s((yyval.expr)->text, EXPR_LENGTH, "%s+%s", (yyvsp[(1) - (3)].expr)->text, (yyvsp[(3) - (3)].expr)->text);
    }
    break;
...
#line 168 "parser.y"
    { 
        ...
        sprintf_s((yyval.expr)->text, EXPR_LENGTH, "-%s", (yyvsp[(2) - (2)].expr)->text);
    }
    break;
...
#line 174 "parser.y"
    {         
        ...
        (yyval.expr)->l = (yyvsp[(1) - (3)].expr), (yyval.expr)->r=(yyvsp[(3) - (3)].expr);  
        sprintf_s((yyval.expr)->text, EXPR_LENGTH, "%s AND %s", (yyvsp[(1) - (3)].expr)->text, (yyvsp[(3) - (3)].expr)->text);
    }
    break;
...
#line 180 "parser.y"
    {        
        ...
        (yyval.expr)->l = (yyvsp[(1) - (3)].expr), (yyval.expr)->r=(yyvsp[(3) - (3)].expr);   
        sprintf_s((yyval.expr)->text, EXPR_LENGTH, "%s OR %s", (yyvsp[(1) - (3)].expr)->text, (yyvsp[(3) - (3)].expr)->text);
    }
    break;
...
#line 186 "parser.y"
    {        
        ...
        (yyval.expr)->l = (yyvsp[(1) - (3)].expr), (yyval.expr)->r=(yyvsp[(3) - (3)].expr);  
        sprintf_s((yyval.expr)->text, EXPR_LENGTH, "%s XOR %s", (yyvsp[(1) - (3)].expr)->text, (yyvsp[(3) - (3)].expr)->text);
    }
    break;
...
#line 204 "parser.y"
    { 
        ...
        (yyval.expr)->l = (yyvsp[(1) - (3)].expr), (yyval.expr)->r = (yyvsp[(3) - (3)].expr);
        sprintf_s((yyval.expr)->text, EXPR_LENGTH, "(%s %s %s)", (yyvsp[(1) - (3)].expr)->text, type_name[(yyvsp[(2) - (3)].subtok)], (yyvsp[(3) - (3)].expr)->text);
    }
    break;
...
#line 210 "parser.y"
    { 
        ...
        sprintf_s((yyval.expr)->text, EXPR_LENGTH, "(%s %s %s)", (yyvsp[(1) - (5)].expr)->text, type_name[(yyvsp[(2) - (5)].subtok)], "SUBQUERY");
    }
    break;
...
#line 219 "parser.y"
    {
        ...
        sprintf_s((yyval.expr)->text, EXPR_LENGTH, "%s", (yyvsp[(1) - (1)].expr)->text);
    }
    break;
...
#line 241 "parser.y"
    { 
        ...
        (yyval.expr)->l = (yyvsp[(1) - (5)].expr), (yyval.expr)->r = (yyvsp[(4) - (5)].expr);
    }
    break;
...
#line 246 "parser.y"
    { 
        ...
        (yyval.expr)->l = (yyvsp[(1) - (6)].expr), (yyval.expr)->r = (yyvsp[(5) - (6)].expr);
    }
    break;
...
#line 251 "parser.y"
    { 
        ...
        (yyval.expr)->l = (yyvsp[(1) - (5)].expr), (yyval.expr)->select = (yyvsp[(4) - (5)].select);
    }
    break;
...
#line 256 "parser.y"
    { 
        ...
        (yyval.expr)->l = (yyvsp[(1) - (6)].expr), (yyval.expr)->select = (yyvsp[(5) - (6)].select);
    }
    break;
...
#line 264 "parser.y"
    {  
        ...
        sprintf_s((yyval.expr)->text, EXPR_LENGTH, "%s(%s)", (yyvsp[(1) - (4)].strval), (yyvsp[(3) - (4)].expr)->text);
    }
    break;
...
#line 275 "parser.y"
    { 
        ...
        sprintf_s((yyval.expr)->text, EXPR_LENGTH, "COUNT(*)");
    }
    break;
...
#line 280 "parser.y"
    { 
        ...
        (yyval.expr)->r = (yyvsp[(3) - (4)].expr);
        sprintf_s((yyval.expr)->text, EXPR_LENGTH, "COUNT(%s)", (yyvsp[(3) - (4)].expr)->text);
    }
    break;
...
#line 286 "parser.y"
    { 
        ...
        sprintf_s((yyval.expr)->text, EXPR_LENGTH, "SUM(*)");
    }
    break;
...
#line 291 "parser.y"
    { 
        ...
        (yyval.expr)->r = (yyvsp[(3) - (4)].expr);
        sprintf_s((yyval.expr)->text, EXPR_LENGTH, "SUM(%s)", (yyvsp[(3) - (4)].expr)->text);
    }
    break;
...
#line 299 "parser.y"
    {
        ...
        (yyval.expr)->case_head = (yyvsp[(3) - (4)].expr);
        sprintf_s((yyval.expr)->text, EXPR_LENGTH, "CASE %s %s END", (yyvsp[(2) - (4)].expr)->text, (yyvsp[(3) - (4)].expr)->text);
    }
    break;
...
#line 306 "parser.y"
    { 
        ...
        (yyval.expr)->case_head = (yyvsp[(3) - (6)].expr);
        sprintf_s((yyval.expr)->text, EXPR_LENGTH, "CASE %s %s ELSE %s END", (yyvsp[(2) - (6)].expr)->text, (yyvsp[(3) - (6)].expr)->text, (yyvsp[(5) - (6)].expr)->text);
    }
    break;
...
#line 313 "parser.y"
    {
        ...
        (yyval.expr)->case_head = (yyvsp[(2) - (3)].expr);
        sprintf_s((yyval.expr)->text, EXPR_LENGTH, "CASE %s END", (yyvsp[(2) - (3)].expr)->text);
    }
    break;
...
#line 319 "parser.y"
    { 
        ...
        (yyval.expr)->case_head = (yyvsp[(2) - (5)].expr);
        (yyval.expr)->r = (yyvsp[(4) - (5)].expr);
        sprintf_s((yyval.expr)->text, EXPR_LENGTH, "CASE %s ELSE %s END", (yyvsp[(2) - (5)].expr)->text, (yyvsp[(4) - (5)].expr)->text);
    }
    break;
...
#line 328 "parser.y"
    {
        (yyval.expr) = calloc(1, sizeof(ExprNode));
        (yyval.expr)->type = EXPR_CASE_NODE;
        (yyval.expr)->l = (yyvsp[(2) - (4)].expr), (yyval.expr)->r = (yyvsp[(4) - (4)].expr);
        sprintf_s((yyval.expr)->text, EXPR_LENGTH, "WHEN %s THEN %s", (yyvsp[(2) - (4)].expr)->text, (yyvsp[(4) - (4)].expr)->text);
    }
    break;
...
#line 334 "parser.y"
    {
        (yyval.expr) = calloc(1, sizeof(ExprNode));
        (yyval.expr)->type = EXPR_CASE_NODE;
        (yyval.expr)->l = (yyvsp[(2) - (5)].expr), (yyval.expr)->r = (yyvsp[(4) - (5)].expr);
        (yyval.expr)->next = (yyvsp[(5) - (5)].expr);
        sprintf_s((yyval.expr)->text, EXPR_LENGTH, "WHEN %s THEN %s %s", (yyvsp[(2) - (5)].expr)->text, (yyvsp[(4) - (5)].expr)->text, (yyvsp[(5) - (5)].expr)->text);
    }
    break;
...
#line 343 "parser.y"
    { 
        ...
        (yyval.expr)->l = (yyvsp[(1) - (3)].expr), (yyval.expr)->r = (yyvsp[(3) - (3)].expr);
        sprintf_s((yyval.expr)->text, EXPR_LENGTH, "(%s LIKE %s)", (yyvsp[(1) - (3)].expr)->text, (yyvsp[(3) - (3)].expr)->text);
    }
    break;
...
#line 349 "parser.y"
    { 
        ...
        sprintf_s((yyval.expr)->text, EXPR_LENGTH, "(%s NOT LIKE %s)", (yyvsp[(1) - (4)].expr)->text, (yyvsp[(4) - (4)].expr)->text);
    }
    break;
